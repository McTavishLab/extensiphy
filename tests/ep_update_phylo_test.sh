...
../extensiphy.sh -u PHYLO -a ../testdata/combo.fas -t ../testdata/combo.tre -d ../testdata -1 _R1.fq -2 _R2.fq -o ep_test_update_phylo >> logfile.txt 2>&1

ALIGN=./ep_test_update_phylo/RESULTS/extended.aln
PHYLO=./ep_test_update_phylo/RESULTS/RAxML_bestTree.consensusFULL
num_seqs=$(grep -c ">" ./ep_test_update_phylo/RESULTS/extended.aln)
num_lines=$(wc -l ./ep_test_update_phylo/RESULTS/extended.aln)
check_tree=$(grep -c ":0.0;" ./ep_test_update_phylo/RESULTS/RAxML_bestTree.consensusFULL)
